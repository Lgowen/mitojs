import { ToStringTypes } from 'remitojs-shared'
import { toStringValidateOption, _support } from 'remitojs-utils'
import { ReportDataType } from 'remitojs-types'
import { BaseTransport } from 'remitojs-core'
import { WxOptionsFieldsTypes } from './types'

export class AliTransport extends BaseTransport<WxOptionsFieldsTypes> {
