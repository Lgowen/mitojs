import { WxPageEvents, WxBreadcrumbTypes } from 'remitojs-shared'
import { voidFun } from 'remitojs-types'
import { firstStrtoLowerCase, isEmptyObject, replaceOld } from 'remitojs-utils'
 ...
 * @return {*}
 */
function pageHookTransform(this: AliClient, hook: WxPageEvents) {
 ...
 * @return {*}
 */
function pageHookTransformWithOptions(this: AliClient, hook: WxPageEvents, options: any) {
  const page = getCurrentPagesPop()
  const { options: sdkOptions } = this
