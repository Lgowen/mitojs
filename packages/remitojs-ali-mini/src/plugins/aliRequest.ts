import {
  ...
  BREADCRUMBCATEGORYS,
  WxBaseEventTypes
} from 'remitojs-shared'
import { fromHttpStatus, getCurrentRoute, getRealPath, getTimestamp, Severity, SpanStatus, variableTypeDetection } from 'remitojs-utils'
import { HttpCollectedType, HttpTransformedType } from 'remitojs-types'
...
function monitorWxXhr(this: AliClient, notify: (eventName: WxEventTypes, data: any) => void) {
...
export function httpTransformedDataConsumer(this: AliClient, transformedData: HttpTransformedType) {
