import { ErrorTypes, WxBaseEventTypes, WxBreadcrumbTypes, WxRouteEvents } from 'remitojs-shared'
import { getCurrentRoute, Severity, variableTypeDetection } from 'remitojs-utils'
import { ReportDataType } from 'remitojs-types'
